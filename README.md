## This is a blog post forked from [Barry Clark](https://github.com/barryclark/jekyll-now). 

### The last 3 blog posts are:
---
1. [Accessing android files from PC via SSH](https://ravieroy.github.io/Android-Tips-Part-2/)

2. [Installing Linux OS on Android platform](https://ravieroy.github.io/Android-Tips-Part-1/)
